        ...
        if ((new_start_date.trim() != "" && new_start_date.trim() != "None") || (new_end_date.trim() != "" && new_end_date.trim() != "None")) {
            ...
            if(converted_date.trim() != "" && new_end_date.trim() != "" && new_end_date.trim() != "None"){
                if(Number(start_year) != Number(end_year)){
                    converted_date = converted_date + ', ' + start_year + ' - ' + new_end_date + ', ' + end_year + ' ' + end_time + ' CT'
                } else {
                    // check if both date are equal
                    if(new_start_date == new_end_date)
                        converted_date = converted_date + ', ' +  start_year + ' ' + start_time + ' - ' + end_time + ' CT'
                    else
                        converted_date = converted_date + ' - ' + new_end_date + ', ' + end_year + ' ' + end_time + ' CT'
                }
            }else{
                converted_date = converted_date+' CT';
            }
