      ...
      if (data.error == 0){
        ...
        if(parseInt(all_data.auction_status) != 1){
          ...
          if(today > count_down_start_date && today < count_down_dutch_end_date){
            ...
            bid_html += '<span class="dollar">$</span> <input type="text" class="form-control input-sm dutch_bid_amount '+bid_amount_class+'" name="dutch_bid_amount" value="'+bid_amount+'" maxlength="10" readonly>';
            ...
            if(all_data.dutch_winning_user_id && parseInt(user_id) != parseInt(all_data.dutch_winning_user_id)){
                ...
                var bid_html = '<form action="" class="make0ffer-form">';
                bid_html += '<span class="dollar">$</span> <input type="text" class="form-control input-sm sealed_bid_amount '+bid_amount_class+'" name="sealed_bid_amount" value="'+bid_amount+'" maxlength="10">';
            ...
            if(parseInt(user_id) == parseInt(all_data.dutch_winning_user_id) || parseInt(user_id) == parseInt(all_data.sealed_winning_user_id)){
                ...
                var bid_html = '<form action="" class="make0ffer-form">';
                bid_html += '<span class="dollar">$</span> <input type="text" class="form-control input-sm bid_amount '+bid_amount_class+'" name="bid_amount" value="'+bid_amount+'" maxlength="10">';
